...
const GuideCard = ({ guide, progressMap }: any) => {
    ...
    return (
        <Link to={`/guide/${guide.slug}`} className={`group bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-brand-400 dark:hover:border-brand-500 hover:shadow-lg transition-all duration-300 flex flex-col h-full overflow-hidden ${isCompleted ? 'opacity-75' : ''}`}>
